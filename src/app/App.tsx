          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 lg:gap-20 items-center">
            ...
            <div className="relative h-[460px] lg:h-[520px] xl:h-[580px] hidden md:block">
              ...
              <div className="absolute top-[140px] lg:top-[152px] left-0 w-[252px] lg:w-[278px] xl:w-[308px] h-[190px] lg:h-[210px] xl:h-[232px] bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 shadow-2xl -rotate-6 hover:-rotate-3 transition-all duration-500 overflow-hidden">
                <ImageWithFallback src="https://images.unsplash.com/photo-1643142314913-0cf633d9bbb5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjYXIlMjBkZWFsZXJzaGlwJTIwc2hvd3Jvb20lMjBhdXRvbW90aXZlfGVufDF8fHx8MTc3NzQwMDUxM3ww&ixlib=rb-4.1.0&q=80&w=1080" alt="StockLog" className="w-full h-full object-cover opacity-80" />
              </div>
