        ...
        >
          <div className={`mx-auto flex w-full max-w-7xl items-center justify-between gap-4 px-4 transition-[padding] duration-300 md:px-8 ${scrolled ? 'py-2' : 'py-3.5'}`}>
            <button onClick={() => scrollTo('top', smooth)} className="flex items-center rounded-lg focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none" aria-label="Boris Milosavac portfolio home">
              <svg viewBox="0 0 64 32" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="h-7 w-auto">
                <path d="M49 7.5C49 3.35786 52.3579 0 56.5 0V0C60.6421 0 64 3.35786 64 7.5V32H49V7.5Z" fill="currentColor" fillOpacity="0.7"/>
                <path d="M32 7.5C32 3.35786 35.3579 0 39.5 0V0C43.6421 0 47 3.35786 47 7.5V32H32V7.5Z" fill="currentColor" fillOpacity="0.7"/>
                <path d="M6 0H10.5C14.6421 0 18 3.35786 18 7.5V7.5C18 11.6421 14.6421 15 10.5 15H6V0Z" fill="currentColor" fillOpacity="0.7"/>
                <path d="M6 17H22.5C26.6421 17 30 20.3579 30 24.5V24.5C30 28.6421 26.6421 32 22.5 32H6V17Z" fill="currentColor" fillOpacity="0.7"/>
              </svg>
            </button>
