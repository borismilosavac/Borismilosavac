      ...
      <section id="top" data-header-theme="dark" className="relative overflow-hidden bg-surface-dark text-white">
        ...
        <div className="relative mx-auto grid min-h-svh w-full max-w-7xl items-center gap-14 px-4 pb-16 pt-28 md:px-8 md:pb-20 md:pt-32 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="min-w-0">
            ...
            <h1 className="max-w-4xl text-balance type-display [overflow-wrap:break-word] hyphens-manual">I design <span className="hero-emphasis" style={{ '--glitch-delay': 'var(--glitch-delay-a)' }}><span className="hero-emphasis__base">complex digital products</span><span className="hero-emphasis__pixel" aria-hidden="true">complex digital products</span></span> that people can <span className="hero-emphasis" style={{ '--glitch-delay': 'var(--glitch-delay-b)' }}><span className="hero-emphasis__base">actually use</span><span className="hero-emphasis__pixel" aria-hidden="true">actually use</span></span>.</h1>
