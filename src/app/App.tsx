        ...
        >
          <div className={`mx-auto flex w-full max-w-7xl items-center justify-between gap-4 px-4 transition-[padding] duration-300 md:px-8 ${scrolled ? 'py-2' : 'py-3.5'}`}>
            <button onClick={() => scrollTo('top', smooth)} className="flex items-center rounded-lg focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none" aria-label="Boris Milosavac portfolio home">
              <svg viewBox="0 0 62 32" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="h-7 w-auto">
                <path d="M0 0.4C0 0.179086 0.179086 0 0.4 0L16.8511 0C20.7993 0 24 3.13402 24 7.00002C24 10.866 20.7993 14 16.8511 14H0.399999C0.179085 14 0 13.8209 0 13.6V0.4Z" fill="currentColor" fillOpacity="0.8"/>
                <path d="M0 18.4C0 18.1791 0.179086 18 0.4 18H16.8511C20.7993 18 24 21.134 24 25C24 28.866 20.7993 32 16.8511 32H0.399999C0.179085 32 0 31.8209 0 31.6V18.4Z" fill="currentColor" fillOpacity="0.8"/>
                <path d="M27.4 32C27.1791 32 27 31.8209 27 31.6L27.0002 7.87476C27.0002 3.52565 30.5818 0 35.0001 0C39.4183 0 43 3.52565 43 7.87476V31.6C43 31.8209 42.8209 32 42.6 32H27.4Z" fill="currentColor"/>
                <path d="M46.4 32C46.1791 32 46 31.8209 46 31.6V7.87476C46 3.52565 49.5817 0 54 0C58.4182 0 62 3.52565 62 7.87476V31.6C62 31.8209 61.8209 32 61.6 32H46.4Z" fill="currentColor"/>
              </svg>
            </button>
